...
const PlayerDock: React.FC<PlayerDockProps> = ({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl glass-effect rounded-2xl h-20 px-8 flex items-center justify-between z-50 shadow-2xl border border-white/5">
      <audio
        ref={audioRef}
      ...
      <div className="flex items-center gap-4 w-1/4">
        {activeFile ? (
          <>
            <div className="w-12 h-12 rounded-lg overflow-hidden border border-white/10 glow-cyan">
      ...
      <div className="flex flex-col items-center gap-2 flex-1 max-w-2xl">
        <div className="flex items-center gap-8">
           ...
           <button 
             onClick={togglePlay}
             disabled={!isPlayable}
             className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-black shadow-lg glow-cyan hover:scale-110 active:scale-95 transition-all"
           >
             {isPlaying ? (
